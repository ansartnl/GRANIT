...
{
    addType(TelegramType::SAM);
    addType(TelegramType::SAM1);
}

AftnMessage * SamCreator::pCreate(const QString &type, const QVariantMap &map) const
{
    AtfFplStruct atf;
