...
SlcCreator::SlcCreator()
{
    addType(TelegramType::SLC);
    addType(TelegramType::SLC1);
}

AftnMessage * SlcCreator::pCreate(const QString &type, const QVariantMap &map) const
{
    AtfFplStruct atf;
